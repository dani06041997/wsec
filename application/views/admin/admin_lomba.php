...
<html>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered datatable">
						  ...
						  <tbody>
							<?php
							foreach($lomba->result() as $baris){
							?>
							<tr>
								<td><?php echo $baris->id;?></td>
								<td class="center"><?php echo $baris->nama;?></td>
								<td class="center"><?php echo $baris->email;?></td>
								<td class="center"><?php echo $baris->contact_person;?></td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="javascript:;" 
										...
										data-email="<?php echo $baris->email;?>"
										data-contact_person="<?php echo $baris->contact_person;?>"
										
										data-toggle="modal" data-target="#edit-data">
										<i class="icon-pen-2">&nbsp;&nbsp;Edit Data</i>                                            
									</a>&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="btn btn-danger" href="<?php echo site_url() ?>/welcome/delete_admin_lomba/<?php echo $baris->id;?>" onClick='return confirm("Anda yakin ingin menghapus data ini?")'>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/add_admin_lomba">
										...
										<div class="form-group">
													...
													<input name="email" class="form-control input-sm" type="text" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Contact Person</label>
													<input name="contact_person" class="form-control input-sm" type="text" required>
			...
			<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/update_admin_lomba">
										...
										<div class="form-group">
													<label class="control-label">Email</label>
													<input name="email" id="email" class="form-control input-sm" type="text" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Contact Person</label>
													<input name="contact_person" id="contact_person" class="form-control input-sm" type="text" required>
	...
	$(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#delete-true').attr("href","<?php echo site_url() ?>/welcome/delete_admin_lomba/<?php echo $baris->id;?>="+id); 
		...
		$('#edit-data').on('show.bs.modal', function (event) {
			...
			var contact_person     = div.data('contact_person');
			...
			modal.find('#contact_person').attr("value",contact_person);
