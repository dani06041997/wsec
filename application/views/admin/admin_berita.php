...
<html>
		...
		<div id="main_wrapper">
			<div id="main_content">
				...
				<div class="page-heading">				
					<h2 class="page-title">
						<i class="icon-calendar"></i> Berita
					</h2>					
				</div>
				<!-- ./ page heading -->
						...
						<table class="table table-striped table-bordered datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td><img src="<?php echo base_url(); ?>/library/images/berita/<?php echo $baris->gambar;?>" width="200" height="150"></td>
								<td class="center"><?php echo $baris->tanggal;?></td>
								<td class="center"><?php echo $baris->isi;?></td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="javascript:;" 
										...
										data-tanggal="<?php echo $baris->tanggal;?>"
										data-isi="<?php echo $baris->isi;?>"
									
										data-toggle="modal" data-target="#edit-data">
										<i class="icon-pen-2">&nbsp;&nbsp;Edit Data</i>                                            
									</a>&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="btn btn-danger" href="<?php echo site_url() ?>/berita/delete_admin_berita/<?php echo $baris->id;?>" onClick='return confirm("Anda yakin ingin menghapus data ini?")'>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="modal-body">
								<div class="box-content">
									<?php echo form_open_multipart('/berita/add_admin_berita'); ?>
										
										<div class="form-group">
													<label class="control-label">Judul</label>
													<input name="judul" class="form-control input-sm" type="text" placeholder="Judul Berita"  required>
										...
										<div class="form-group">
													...
													<input name="tanggal" class="form-control input-sm" type="text" placeholder="DD/MM/YY" required>
													
												</div> 
												<div class="form-group">
													<label class="control-label">Isi</label>
													<textarea name="isi" class="form-control input-sm" type="text" placeholder="Isi Berita" required></textarea>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<?php echo form_open_multipart('/berita/update_admin_berita'); ?>
					...
					<div class="modal-body">
						  ...
						  <fieldset>						  	
						    ...
						    <div class="form-group">
													<label class="control-label">Judul</label>
													<input name="judul" id="judul" class="form-control input-sm" type="text" required>
							...
							<div class="form-group">
													<label class="control-label">Tanggal</label>
													<input name="tanggal" id="tanggal" class="form-control input-sm" type="text" required>
													
												</div> 

						     <div class="form-group">
						      <label for="Isi">Isi</label>
						      <textarea type="text" id="isi" name="isi" class="form-control" placeholder="Masukkan Isi" required>
							  </textarea>
						    </div>
	...
	$(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#delete-true').attr("href","<?php echo site_url() ?>/berita/delete_admin_berita/<?php echo $baris->id;?>="+id); 
...
$('#edit-data').on('show.bs.modal', function (event) {
			...
			modal.find('#gambar').attr("src", '<?php echo base_url(); ?>/library/images/berita/'+gambar);
			modal.find('#tanggal').attr("value",tanggal);
			modal.find('#isi').attr("value",isi);
