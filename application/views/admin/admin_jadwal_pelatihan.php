				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered datatable">
						  ...
						  <tbody>
							<?php
							foreach($jadwal_pelatihan->result() as $baris){
							?>
							<tr>
								<td><?php echo $baris->id;?></td>
								<td class="center"><?php echo $baris->prodi;?></td>
								<td class="center"><?php echo $baris->materi;?></td>
								<td class="center"><?php echo $baris->jam;?></td>
								<td class="center"><?php echo $baris->hari;?></td>
								<td class="center">
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="btn btn-info" href="javascript:;" 
										data-id="<?php echo $baris->id;?>" 
										data-prodi="<?php echo $baris->prodi;?>" 
										data-materi="<?php echo $baris->materi;?>"
										data-jam="<?php echo $baris->jam;?>"
										data-hari="<?php echo $baris->hari;?>"
										data-toggle="modal" data-target="#edit-data">
										<i class="icon-pen-2">&nbsp;&nbsp;Edit Data</i>                                            
									</a>&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="btn btn-danger" href="<?php echo site_url() ?>/welcome/delete_admin_jadwal_pelatihan/<?php echo $baris->id;?>" onClick='return confirm("Anda yakin ingin menghapus data ini?")'>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/add_admin_jadwal_pelatihan">
										<div class="form-group">
													<label class="control-label">Prodi</label>
													<select id="select-beast" name="prodi" class="form-control selectize-single" type="text"placeholder="Pilih Prodi" required>
										...
										<div class="form-group">
													...
													<input name="materi" class="form-control input-sm" type="text" placeholder="Materi"  required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Jam</label>
													<input name="jam" class="form-control input-sm" type="text" placeholder="00:00" required>
													
												</div> 
												<div class="form-group">
													<label class="control-label">Tanggal</label>
													<input name="hari" class="form-control input-sm" type="text" placeholder="DD/MM/YY" required>
			...
			<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/update_admin_jadwal_pelatihan">
										<input type="hidden" name="id" id="id">
										<div class="form-group">
													<label class="control-label">Prodi</label>
												    <input id="prodi" name="prodi" class="form-control input-sm" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Materi</label>
													<input name="materi" id="materi" class="form-control input-sm" type="text" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Jam</label>
													<input name="jam" id="jam" class="form-control input-sm" type="text" required>
													
												</div> 
												<div class="form-group">
													<label class="control-label">Tanggal</label>
													<input name="hari" id="hari" class="form-control input-sm" type="text" required>
