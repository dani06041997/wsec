...
<div id="main_wrapper">
			<div id="main_content">
				...
				<div class="page-heading">				
					<h2 class="page-title">
						<i class="icon-camera"></i> Gallery Umum
					</h2>					
				</div>
				<!-- ./ page heading -->
				...
				<ol class="breadcrumb breadcrumb-main">
					<li><a href="#">Home</a></li>
					<li class="active">Gallery Umum</li>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php
							foreach($gumum->result() as $baris){
							?>
							<tr>
								<td><?php echo $baris->id;?></td>
		
								<td class="center"><?php echo $baris->keterangan;?></td>
								<td><img src="<?php echo base_url(); ?>/library/images/gumum/<?php echo $baris->gambar;?>" width="200" height="150"></td>
								<td class="center">
									&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<a class="btn btn-danger" href="<?php echo site_url() ?>/welcome/delete_admin_gumum/<?php echo $baris->id;?>" onClick='return confirm("Anda yakin ingin menghapus data ini?")'>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="modal-body">
								<div class="box-content">
									<?php echo form_open_multipart('/welcome/add_admin_gumum'); ?>
	...
	<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<?php echo form_open_multipart('/welcome/update_admin_gumum'); ?>
				...
				<div id="modal-konfirmasi" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<a class="btn btn-danger" id="delete-true" href="<?php echo site_url() ?>/welcome/delete_admin_gumum/<?php echo $baris->id;?>">Ya</a>
	...
	$(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#delete-true').attr("href","<?php echo site_url() ?>/welcome/delete_admin_gumum/<?php echo $baris->id;?>="+id); 
...
$('#edit-data').on('show.bs.modal', function (event) {
			...
			modal.find('#gambar').attr("src", '<?php echo base_url(); ?>/library/images/gumum/'+gambar);
