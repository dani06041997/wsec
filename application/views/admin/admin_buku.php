...
<html>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered datatable">
						  ...
						  <tbody>
							<?php
							foreach($buku->result() as $baris){
							?>
							<tr>
								<td><?php echo $baris->id;?></td>
								<td class="center"><?php echo $baris->nama_bk;?></td>
								<td class="center"><?php echo $baris->jenis_bk;?></td>
								<td class="center"><?php echo $baris->stok;?></td>
								<td class="center">
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="btn btn-info" href="javascript:;" 
										data-id="<?php echo $baris->id;?>" 
										data-nama_bk="<?php echo $baris->nama_bk;?>" 
										data-jenis_bk="<?php echo $baris->jenis_bk;?>"
										data-stok="<?php echo $baris->stok;?>"
										data-toggle="modal" data-target="#edit-data">
										<i class="icon-pen-2">&nbsp;&nbsp;Edit Data</i>                                            
									</a>&nbsp;&nbsp;&nbsp;&nbsp;
									<a class="btn btn-danger" href="<?php echo site_url() ?>/welcome/delete_admin_buku/<?php echo $baris->id;?>" onClick='return confirm("Anda yakin ingin menghapus data ini?")'>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/add_admin_buku">
										<div class="form-group">
													<label class="control-label">Nama Buku</label>
													<input name="nama_bk" class="form-control input-sm" type="text" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Jenis Buku</label>
													<input name="jenis_bk" class="form-control input-sm" type="text" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Stok</label>
													<input name="stok" class="form-control input-sm" type="text" required>
			...
			<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/update_admin_buku">
										<input type="hidden" name="id" id="id">
										<div class="form-group">
													<label class="control-label">Nama Buku</label>
												    <input id="nama_bk" name="nama_bk" class="form-control input-sm" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Jenis Buku</label>
													<input name="jenis_bk" id="jenis_bk" class="form-control input-sm" type="text" required>
													
												</div> 
										<div class="form-group">
													<label class="control-label">Stok</label>
													<input name="stok" id="stok" class="form-control input-sm" type="text" required>
	...
	$(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#delete-true').attr("href","<?php echo site_url() ?>/welcome/delete_admin_buku/<?php echo $baris->id;?>="+id); 
		...
		$('#edit-data').on('show.bs.modal', function (event) {
			...
			var id 					= div.data('id');
			var nama_bk 				= div.data('nama_bk');
			var jenis_bk 			= div.data('jenis_bk');
			...
			modal.find('#nama_bk').attr("value", nama_bk);
			modal.find('#jenis_bk').attr("value",jenis_bk);
			modal.find('#stok').attr("value",stok);
