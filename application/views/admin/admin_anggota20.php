		...
		<div id="main_wrapper">
			<div id="main_content">
				...
				<div class="page-heading">				
					<h2 class="page-title">
						<i class="icon-star-3"></i> Dinasty 20
					</h2>					
				</div>
				<!-- ./ page heading -->
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-danger" href="<?php echo site_url() ?>/welcome/delete_admin_anggota20/<?php echo $baris->id;?>" onClick='return confirm("Anda yakin ingin menghapus data ini?")'>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/add_admin_anggota20">
			...
			<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
							...
							<div class="modal-body">
								<div class="box-content">
									<form name="form-validate" class="form-validate" method="post" action="<?php echo site_url(); ?>/welcome/update_admin_anggota20">
