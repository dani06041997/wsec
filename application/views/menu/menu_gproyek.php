...
<body style="margin-top:-16px;" id="home">
    ...
    <div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-images"></i><span class="break"></span> Gallery Proyek</h2>
	...
	?>
								...
								<a title="<?php echo $baris->keterangan;?>" href="<?php echo base_url(); ?>/library/images/gproyek/<?php echo $baris->gambar;?>"><img class="grayscale" src="<?php echo base_url(); ?>/library/images/gproyek/<?php echo $baris->gambar;?>" alt="gallery" width="320" height="270"></a>
							</div>
										<?php } ?>			
