...
class Usermodel_anggota20 extends CI_Model {
	...
	$this->polinema_wsec->from('anggota20');
	...
	function add($data)
	{
	$this->polinema_wsec->insert('anggota20',$data);
	}
	
	function edit($id,$data)
	{
	$this->polinema_wsec->where('id',$id);
	$this->polinema_wsec->update('anggota20',$data);
	}
	function delete($id)
	{
	$this->polinema_wsec->where('id',$id);
	$this->polinema_wsec->delete('anggota20');
	}	
}