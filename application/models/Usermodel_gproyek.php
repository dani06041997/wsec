...
class usermodel_gproyek extends CI_Model {
	...
	$this->polinema_wsec->from('gproyek');
	...
	function add($data)
	{
	$this->polinema_wsec->insert('gproyek',$data);
	}
	
	function edit($id,$data)
	{
	$this->polinema_wsec->where('id',$id);
	$this->polinema_wsec->update('gproyek',$data);
	}
	function delete($id)
	{
	$this->polinema_wsec->where('id',$id);
	$this->polinema_wsec->delete('gproyek');
	}
